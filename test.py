...
manager = guis.UIManager(screen, True, ["example.gss"], None, {
    "MENU": menu_surf,
...
with guis.VStack(guis.SizeR(1200, 800), style_id="invis_cont"):
    with guis.VStack(guis.SizeR(600,700), style_id="no_scroll"):
        ...
        sl = guis.SelectionList(["ma", "sta", "cosa", "funziona?", "boh"], guis.SizeR(200,200), settings=guis.SelectionListSettings(multi_select=True))
