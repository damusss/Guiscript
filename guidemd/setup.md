...
# Getting Started
Here i'll show you a code example on how to create the application loop, the manager and an element tree.<br>
Follow the readme instructions to install guiscript.
